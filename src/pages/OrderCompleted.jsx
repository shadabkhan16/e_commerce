    ...
    <div className="container mx-auto py-12 px-6 lg:px-20 text-center">
      ...
      <div className="flex items-center justify-center mb-12 space-x-8">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className=" bg-green-500">Order complete</span>
        </div>
      </div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 lg:p-16 mb-8">
        ...
        <div className="flex justify-center mb-6 space-x-8">
          {orderDetails.map((item, index) => (
            <div key={item.id} className="flex flex-col items-center">
              ...
              <div className="w-8 h-8 bg-black text-white flex items-center justify-center rounded-full mt-2">
                {index + 1}
              </div>
            </div>
          ))}
        ...
        <div className="text-left space-y-2">
          <p className="text-lg">
            Order code: <span className="font-semibold">{Date.now()}</span>
          </p>
          <p className="text-lg">
          ...
          <p className="text-lg">
            Total:{" "}
            <span className="font-semibold">${calculateAmount() + 15}</span>
          </p>
          <p className="text-lg">
            Payment method: <span className="font-semibold">UPI</span>
          </p>
        </div>
